...
import io.jmnarloch.spring.cloud.feign.app.client.InvoiceClient;
import io.jmnarloch.spring.cloud.feign.app.domain.Invoice;
...
/**
 * Tests the usage of OkHttp.
 *
 * @author Jakub Narloch
 */
@WebAppConfiguration
@IntegrationTest({"server.port=0"})
@SpringApplicationConfiguration(classes = {OkHttpClientTest.Application.class})
